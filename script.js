...
function page1(){
    ...
    document.getElementById("nasa").style.visibility ="hidden";
    ...
    document.getElementById("vr90s").style.visibility ="hidden";
...
function page2(){
    ...
    document.getElementById("sensorama").style.visibility ="hidden";
